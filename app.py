...
if st.session_state.pagina == 'home':
    ...
    with col_centro:
        ...
        st.markdown("<h1 style='text-align: center; font-size: 68px; font-weight: 900; line-height: 1;'>GIOCA. RIVEDITI.<br><span style='color: #2ecc71;'>CONDIVIDI.</span></h1>", unsafe_allow_html=True)
