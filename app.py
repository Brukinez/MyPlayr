...
""", unsafe_allow_html=True)
    ...
    """, unsafe_allow_html=True)
        ...
        with st.form("news_form", clear_on_submit=True):
            ...
            st.markdown("<p style='color: #94a3b8; font-size: 20px; margin-bottom: 0px; text-align: center;'>Iscriviti alla newsletter per ricevere novità, offerte e aggiornamenti sul mondo MyClipzo</p>", unsafe_allow_html=True)
