        ...
        if st.session_state.sub == 'login':
            ...
            st.markdown("""
                <div style='text-align: center; margin-bottom: 20px;'>
                    ...
                    <h1 style='font-weight: 900; font-size: 24px; margin-bottom: 0; color: white;;'>ACCEDI A<br><span style='color: #2ecc71;'> MYCLIPZO</span></h1>             
                </div>
            """, unsafe_allow_html=True)
          ...
          # --- 2. SOTTO-PAGINA: REGISTRAZIONE (STILE MYPLAYR + LOGICA SUPABASE) ---
            ...
            st.markdown("""
                <div style='text-align: center; margin-bottom: 0px;'>
                    ...
                    <h1 style='font-weight: 700; margin-bottom: 0; color: white;'>CREA IL TUO<br><span style='color: #2ecc71;'> ACCOUNT</span></h1>
